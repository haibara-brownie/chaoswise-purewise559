pipeline{
    ...
    environment {
        ...
        // git 仓库地址
        git_url="https://git.cloudwise.com/DOCP/aops_aopc_user_web.git"
    ...
    // 手动部署时所需参数
    parameters {
        string defaultValue: 'dev', description: '输入你要构建的分支：', name: 'branch', trim: true
    ...
    triggers {
        GenericTrigger(
            ...
            token: 'douc-doucWeb-devops',
            tokenCredentialId: '',
            printContributedVariables: false,
            printPostContent: true,
            silentResponse: false,
            regexpFilterExpression: '(/dev)$', regexpFilterText: '$push_branch'
        )
    }
